    ...
    <footer className="mt-auto px-4 py-12 text-center border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950/50 text-gray-500 dark:text-gray-400">
      <div className="max-w-4xl mx-auto">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex mt-4 justify-center items-center gap-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
        >
          <span className="sr-only">Built with Astro</span>
          <svg
            width="32"
            height="32"
            viewBox="0 0 85 107"
          ...
          <span className="text-content-small">built with Astro</span>
        </a>
